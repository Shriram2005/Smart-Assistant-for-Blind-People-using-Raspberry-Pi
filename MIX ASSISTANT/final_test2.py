...
class SmartAssistant:
    def __init__(self):
        ...
        # OCR config using LSTM engine
        self.ocr_config = r'--oem 1 --psm 3 -l eng'
        
        # Fallback OCR config with minimal options
    ...
    def load_knowledge(self):
        ...
        try:
            # Using absolute path to knowledge_data.json
    ...
    def setup_camera(self):
        ...
        try:
            ...
            print("Camera functionality may not be available")
    ...
    def read_text(self):
        ...
        def process_image_thread():
            try:
                ...
                # Try all OCR options with proper error handling
                text = ""
                try:
    ...
    def translate_text(self, target_lang):
        ...
        try:
            ...
            if not self.last_extracted_text or self.last_extracted_text.strip() == "":
                ...
                # Try OCR options with proper error handling
                text = ""
                try:
            ...
            def translate_in_background():
                try:
                    ...
                    self.speak("Translation failed. Please try again.")
    ...
    def show_help(self):
        ...
        self.speak("Here are the available commands.", use_tts=False)
        self.speak(self.help_text.replace("-", "").strip())
    ...
    def recognize_speech(self):
        """Fixed speech recognition function to address list indices error"""
        ...
        try:
            with sr.Microphone() as source:
                ...
                # Primary recognition method with explicit language
                try:
                    ...
                    # Try fallback recognition if available
                    try:
                        command = self.recognizer.recognize_sphinx(audio)
                        print(f"Fallback recognized: {command}")
                        self.execute_command(command)
                    except:
                        self.speak("Sorry, I'm having trouble with speech recognition. Please try again.")
    ...
    def start_listener(self):
        ...
        try:
            ...
            self.speak("Error starting keyboard listener. Press Ctrl+C to exit.")
