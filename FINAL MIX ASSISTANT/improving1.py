...
class SmartAssistant:
    def __init__(self):
        ...
        self.button_thread = None  # Changed from listener_thread
    ...
    def show_camera(self):
        ...
        self.speak("Starting camera. Please wait.")
        self.camera_on = True
        
        def camera_feed():
            try:
                self.picam2.start()
                self.speak("Camera is now active.")
                ...
                self.camera_on = False
                self.speak("There was a problem with the camera. Please try again.")
    ...
    def read_text(self):
        ...
        self.speak("Taking a photo to read text. Please hold steady.")
        ...
        def process_image_thread():
            try:
                ...
                frame = self.picam2.capture_array()
                self.speak("Image captured. Processing the text.")
