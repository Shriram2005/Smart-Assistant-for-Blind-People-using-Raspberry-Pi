...
# === Run OCR Workflow ===
image_path = r'C:\Users\Shriram\Desktop\project\OCR_laptop_v1\Demo Images\img7.jpg' # Add path to the input image
...
text_file_path = "" # Create a text file and add it's path here 
