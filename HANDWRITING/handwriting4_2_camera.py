...
class HandwritingRecognizer:
    def __init__(self, language="en", use_gpu=False):
        ...
        # Initialize text-to-speech engine using SAPI
        self.speaker = win32com.client.Dispatch("SAPI.SpVoice")
        # Adjust speech settings
        self.speaker.Rate = 0  # Range from -10 to 10, 0 is default speed
        self.speaker.Volume = 100  # Range from 0 to 100
...
def main():
    """Main function to run the camera-based OCR system."""
    recognizer = HandwritingRecognizer()
    ...
    while True:
        ...
        if key == ord('q'):
            ...
            # Process the image
            text = recognizer.process_image(temp_image, debug=True)
