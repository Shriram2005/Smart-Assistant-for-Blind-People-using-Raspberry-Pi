...
# Specify the path to Tesseract executable for Raspberry Pi users
pytesseract.pytesseract.tesseract_cmd = "/usr/bin/tesseract"  # Path for Raspberry Pi
...
def capture_and_translate(target_lang='mr'):
    ...
    while True:
        ...
        if key == ord('c'):
            ...
            extracted_text = pytesseract.image_to_string(image_path, lang='mar')
